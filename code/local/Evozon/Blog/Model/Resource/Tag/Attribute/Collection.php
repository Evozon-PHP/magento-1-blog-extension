<?php
/**
 * Tag attribute collection model
 *
 * @category    Evozon
 * @package     Evozon_Blog
 */
class Evozon_Blog_Model_Resource_Tag_Attribute_Collection extends Mage_Eav_Model_Resource_Entity_Attribute_Collection
{
    /**
     ...
     *
     * @access protected
     * @return Evozon_Blog_Model_Resource_Tag_Attribute_Collection
    ...
    protected function _initSelect()
    {
        $this->getSelect()->from(array('main_table' => $this->getResource()->getMainTable()))
            ->where(
                ...
                Mage::getModel('eav/entity')->setType(Evozon_Blog_Model_Resource_Tag_Collection::ENTITY)->getTypeId()
            )
            ->join(
