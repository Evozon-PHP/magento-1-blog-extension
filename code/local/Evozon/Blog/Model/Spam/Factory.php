 ...
 */
class Evozon_Blog_Model_Spam_Factory extends Evozon_Blog_Model_Abstract
{
    /**
     * Instance of Evozon_Blog_Model_Spam_Service_Interface
     */
    ...
    public function getSpamService()
    {
        if (!$this->spamService) {
            ...
            /** @var Evozon_Blog_Model_Spam_Service_Interface _spamService */
            ...
            /** @var Evozon_Blog_Model_Spam_Client_Interface $client */
