 ...
 */
class Evozon_Blog_Model_Spam_Client_Zend_Http_Client extends Zend_Http_Client
    implements Evozon_Blog_Model_Spam_Client_Interface
{
    ...
    protected $config
        = array(
            ...
            'timeout'         => 10,
            'adapter'         => 'Evozon_Blog_Model_Spam_Client_Zend_Http_Client_Curl',
