 ...
 */
abstract class Evozon_Blog_Model_Spam_Service_Abstract extends Evozon_Blog_Model_Abstract
{    
    /**
    ...
    /**
     * @var Evozon_Blog_Model_Spam_Client_Interface
     */
    protected $client;
     ...
     * Get Client
     *
     * @return Evozon_Blog_Model_Spam_Client_Interface|false|Mage_Core_Model_Abstract
     */
    public function getClient()
    {
        if (!$this->client) {
            $this->client = Mage::getModel('evozon_blog/spam_client_zend_http_client');
        }
        return $this->client;
    }
