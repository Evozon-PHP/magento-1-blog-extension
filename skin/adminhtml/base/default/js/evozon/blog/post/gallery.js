...
Post.Gallery = Class.create();
Post.Gallery.prototype = {
    images : [],
    file2id : {
        'no_selection' :0
    },
    ...
    updateImage : function(file) {
        ...
        this.images[index].position = this.getFileElement(file,
                'cell-href input').value;
        this.images[index].href = this.getFileElement(file,
                'cell-href input').value;
        this.images[index].position = this.getFileElement(file,
    ...
    updateVisualisation : function(file) {
        ...
        this.getFileElement(file, 'cell-href input').value = image.href;
